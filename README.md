...
|[ПРОЕКТ сервиса Repetit.ru](clck.ru/38jSaD)|Построение ML-продукта для оптимизации классификации заявок на оплату для сервиса Repetit.ru|python, pandas, numpy, statsmodels, sklearn, CatBoost, matplotlib|
